import { Controller, Get, Post, Body, Patch, Param, Delete, UploadedFiles, BadRequestException, UseInterceptors, Req, HttpStatus } from '@nestjs/common';
...
export class ExpensesController {
    ...
    async update(@Param('id') id: string, @Body() updateExpenseDto: UpdateExpenseDto) {
        const updatedExpense = await this.expensesService.update(id, updateExpenseDto);
        return {
            status: 'success',
